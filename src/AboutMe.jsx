...
const REVEAL_CONTENT = [
  {
    upper: ["Name: Sheyden", "Age: 23"],
    lower: "Major: Computer Science",
  },
  {
    upper: [
      "I love creating stuff, either personal projects, game jams,",
      "even random applications that I need for myself !",
      "I'm always full of ideas, and I love bringing life to them",
    ],
    lower: "- sometimes it takes too much of my time",
  },
  {
    upper: [
      "I'm not only a developer, I also teach but,",
      "I also do many other things on my free time, art, music, singing, video editing, and so much more...",
      "So many things to discover !",
    ],
    lower: "why would I only do a single thing ?",
  },
];
...
const ITEMS = [
  {
    id: "twitch", label: "ABOUT ME", handle: "sheyden_n", href: "https://twitch.tv/sheyden_n", icon: "🎮", barIcon: icon1, bars: 1, newBars: [0], counts: ["56"],
  ...
  {
    id: "tiktok", label: "WEIRD FACT ABOUT ME", handle: "@yourhandle", href: "https://tiktok.com/@yourhandle", icon: "🎵", barIcon: icon3, bars: 7, newBars: [0, 3, 5, 6], counts: ["5.1M", "3.7M", "2.2M", "1.4M", "831K", "490K", "217K"],
