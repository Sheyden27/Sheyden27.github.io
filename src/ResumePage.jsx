...
const EDUCATION_ROWS = [
  ...
  { index: "02", title: "Computer Science Master", status: "Complete" },
  { index: "03", title: "Personal Projects", status: "In Progress" },
  { index: "04", title: "Teaching", status: "In Progress" },
  { index: "05", title: "Developing Skills", status: "Queued" },
];
...
const EXPERIENCE_ROWS = [
  { index: "01", title: "Internship Wordpress dev & redactor", status: "Complete" },
  { index: "02", title: "1y Internship Mobile App Dev", status: "Complete" },
  { index: "03", title: "1y Internship for website dev", status: "Complete" },
  { index: "04", title: "Teaching Computer Science", status: "In Progress" },
  { index: "05", title: "Developing Skills", status: "Queued" },
];
...
export default function ResumePage({ src }) {
  ...
  useEffect(() => {
    const onKey = (e) => {
      ...
      if (e.key === "Backspace" && active != 5) setActive(5);
      if (e.key === "Backspace" && active === 5) navigate(-1);
    };
        ...
        {active === 0 && (
          <div className="resume-detail-panel">
            <div className="resume-detail-top">
              ...
              <div className="resume-detail-top-progress">2/5</div>
            </div>
            ...
            <div className="resume-detail-bottom">
              ...
              <div className="resume-detail-bullets">
                ...
                <div className="resume-detail-bullet">- Keep materials prepared for jobs, research, and review.</div>
              </div>
            </div>
          </div>
        )}
        ...
        {active === 2 && (
          <div className="resume-detail-panel">
            <div className="resume-detail-top">
              ...
              <div className="resume-detail-top-progress">8/5</div>
            </div>
        ...
        {active === 3 && (
          <div className="resume-detail-panel">
            <div className="resume-detail-top">
              ...
              <div className="resume-detail-top-progress">6/5</div>
            </div>
